...
pattern_datas["Kebutuhan Umum"] = "KENKO CUTTER| SWALLOW SJD|WAGON CONTAINER BOX|GAJAH TIKUS TRAP|BATERAI ABC|RAJAWALI TS PANJANG LABEL KUNING XL|PLASTIK WRAP|SENDAL|sendal|Plastik warp|SPONS CUCI PIRING SCOTCH-BRITE|TRASH BAG|PENSIL FABER CASTELL|PULPEN FABER CASTELL|Kartu|Tiket|Saldo|PRINTER INK|KERTAS|BUKU|PENSIL|PENGHAPUS|Pulpen|Materai|Baterai|PLASTIK|PLASTIK Besar|Kispray|Kuota|Pulsa"
...
pattern_datas["Alat Mandi"] = "PERALATAN MANDI AIR|PERALATAN MANDI|HANDUK"
...
pattern_datas["Alat Rumah"] = "CERMIN|KARPET|Tas|Sandal|LAMPU BOHLAM|LAMPU|KURSI|ALAT MASAK|KOP"
